...
K1=cell2mat(K(1,:));
Ku=K1*Mp_tmp;
Ke(1,1)=sum(K1(1,1:3:N*ny));
Ke(1,2)=sum(K1(1,2:3:N*ny));
Ke(1,3)=sum(K1(1,3:3:N*ny));
Ke(2,1)=sum(K1(2,1:3:N*ny));
Ke(2,2)=sum(K1(2,2:3:N*ny));
Ke(2,3)=sum(K1(2,3:3:N*ny));
Ke(3,1)=sum(K1(3,1:3:N*ny));
Ke(3,2)=sum(K1(3,2:3:N*ny));
Ke(3,3)=sum(K1(3,3:3:N*ny));
Ke(4,1)=sum(K1(4,1:3:N*ny));
Ke(4,2)=sum(K1(4,2:3:N*ny));
Ke(4,3)=sum(K1(4,3:3:N*ny));
...
for k=9:n
   [Y1(k),Y2(k),Y3(k)]=symulacja_obiektu2_p4(U1(k-1),U1(k-2),U1(k-3),U1(k-4),...
    ...
    Ku_tmp=Ku*dUp_tmp;
    du=K1_tmp-Ku_tmp; %Mno?enie Mp*dUp
