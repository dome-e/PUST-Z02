...
Mo¿na napisaæ o tym, ¿e realizowane w MATLABie i jakie oznaczenia maj¹ jakie rzeczy (W1 ma index 1,  G1 jaki index i T1 jaki index)
...
\textcolor{red}{
	Czy w³aœciwoœci statyczne obiektu mo¿na okreœliæ jako (w przybli¿eniu) liniowe? Jeœli tak wyznaczyæ wzmocnienie statyczne procesu?
}
...
%18:  zad5_lab1_pid_k18
%- niedokoñczone bo by³ chyba Yzad za du¿y + Umax z³y (??)
...
%20_1:   pid_proba1_k20
%- by³ chyba Yzad za du¿y + Umax z³y (??)

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.22]{png/lab2/pid_proba1_k20.png}
...
%20_2:   zad5_lab1_pid_k20_yzad33_a_nie_50
%- ju¿ Yzad dobre ale nadal Umax z³y (??) wiêc za wolno ros³o

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.22]{png/lab2/zad5_lab1_pid_k20_yzad33_a_nie_50.png}
...
%20_3:   zad5_lab1_pid_k20_yzad33_a_nie_50_lepsze_bo_inne_deltaUmax
%- ju¿ ok, ale nadal gasn¹ oscylacje

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.22]{png/lab2/zad5_lab1_pid_k20_yzad33_a_nie_50_lepsze_bo_inne_deltaUmax.png}
...
%24
%zad5_lab1_pid_k24_yzad33_a_nie_50_lepsze_bo_inne_deltaUmax_to_20
%- niegasn¹ce oscylacje

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.22]{png/lab2/zad5_lab1_pid_k24_yzad33_a_nie_50_lepsze_bo_inne_deltaUmax_to_20.png}
