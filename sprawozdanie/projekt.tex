% !TEX encoding = cp1250
\chapter{Projekt}
Implementacja projektu znajduje siê w pliku pro\_zad12.mlx.
...
Obiekt zosta³ pobudzony czterema ró¿nymi sygna³ami mieszcz¹cymi siê w zakresie [$U_{min}$, $U_{max}$]. 
...
Wzmocnienie statyczne wyznaczone jest jako wspó³czynnik kierunkowy charaktetystyki z Rys. \ref{rys_zad22}:
\begin{align*}
K_{stat}=1,6966
\end{align*}
...
W celu wyznaczenia liczb $s_1, s_2, s_3...$ wykorzystana zosta³a odpowiedŸ skokowa dla pobudzenia $U = 1.2$. Jej przekszta³cenie przebieg³o zgodnie ze wzorem \ref{w_Si}.
...
Program do symulacji cyfrowego algorytmu PID znajduje siê w pliku PID\_zad4.m
