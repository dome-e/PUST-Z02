...
Punkty charakterystyki statycznej Y(U) s¹ po³o¿one w bliskiej odleg³oœci od dopasowanej prostej (Rys. \ref{rys_zad2_char}. Oznacza to, ¿e w³aœciwoœci statyczne obiektu s¹ w przybli¿eniu linowe. Wzmocnienie statyczne obiektu to zatem $K_{stat} = 0,3188$
...
// TODO - opis PIDa rozmytego i jak byœmy go zaimplementowali. 

Zespó³ nie zd¹¿y³ zaimplementowaæ jednak algorytmu realizuj¹cego regulacjê PID w czasie trwania laboratorium.
